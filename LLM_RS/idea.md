...
## 后续工作方向
    ...
    2. C3Rec的工作很牛逼：用“做题表现”推测学生的认知状态（知识掌握度）→ 用这套认知状态作为“教师模型”指导课程推荐系统，提升推荐效果。涉及学生–习题图，习题–知识点图，用 IRT（项目反应理论）构建认知结构。  ->  **怎么follow呢**？

    3. Follow CORONA， 通过大语言模型分别推理学生的学习偏好与意图，以及课程的知识侧重点、前置要求与难度属性，并将这组“学生–课程双侧语义表征”作为检索先验，从课程知识图谱中筛选个性化子图，再由图模型进行精排推荐。
