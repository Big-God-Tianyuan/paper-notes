...
可解释的推荐研究可以考虑推荐方法或推荐结果的可解释性，对应于模型内在和模型不可知的方法。这两种建模哲学都源于人类认知科学。有时，人类基于仔细的逻辑推理做出决策，因此他们可以通过逐步展示推理过程来清楚地解释决策是如何做出的。在这种情况下，决策模型是透明的并且可以自然地提供解释。其他时候，人们首先做出直觉决定，然后“寻求”对该决定的解释，这属于事后解释方法。
